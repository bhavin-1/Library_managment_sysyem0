...
<tr><th align="center" colspan="7" class="s" >Author Details</th></tr><tr></tr><tr></tr>
<tr>
<th class="s">ID</th>
<th class="s">AUTHOR NAME</th>
<th class="s">ADDRESS</th>
<th class="s">PHONE NO</th>
<th class="s">EDIT</th>
...
%>
	<tr>
		...
		<td><a class="s" href="editauthor.jsp?id=<%=  id %>">Edit</a></td>
		<td><a class="g" href="deleteauthor.jsp?id=<%=  id %>">Delete</a></td>
	</tr></tbody>
<%
	}
	rs.close();
